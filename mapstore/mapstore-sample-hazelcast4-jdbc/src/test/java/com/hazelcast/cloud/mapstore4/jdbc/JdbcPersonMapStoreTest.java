...
public class JdbcPersonMapStoreTest {

    @ClassRule
    public static final MySQLContainer<?> mysql = new MySQLContainer<>("mysql:5.7.22")
    ...
    public static void init() {
        ...
        mapStoreConfig.setClassName(JdbcPersonMapStore.class.getCanonicalName());
